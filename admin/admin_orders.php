...
require '../src/Exception.php';  // Path to PHPMailer\Exception.php
require '../src/PHPMailer.php';   // Path to PHPMailer\PHPMailer.php
require '../src/SMTP.php';        // Path to PHPMailer\SMTP.php
...
if ($orderinfo_data) {
    ...
    try {
        ...
        $mail->Password = 'fooo izvg geou uaac';         
        $mail->SMTPSecure = PHPMailer::ENCRYPTION_SMTPS;
        $mail->Port = 465;  

        // Sender and recipient
        $mail->setFrom('romerosfragrance@gmail.com', 'RomeRos');
        ...
        <p>Best regards,<br>ROMEROS FRAGRANCE</p>
        ";
